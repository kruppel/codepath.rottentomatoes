...
class MovieViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let tmb = movie.valueForKeyPath("posters.detailed") as NSString
        let range:NSRange = tmb.rangeOfString("_tmb.jpg$", options: .RegularExpressionSearch)
        let orig = tmb.stringByReplacingCharactersInRange(range, withString: "_ori.jpg")
